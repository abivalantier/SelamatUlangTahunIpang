...
new TypeIt("#teks1", {
  strings: ["Hari ini, abii langitkan semua doa terbaik saya untuk ipang.", "Semoga hal-hal yang membuat ipang runtuh turut menjadi alasan ipang untuk tetap tumbuh.", "Semoga dunia senantiasa menjaga ipang dimanapun ipang berada.", "Semoga hari-hari ipang selalu diiringi cinta yang tak pernah ada batasnya." , "Semoga setiap langkah ipang dimudahkan hingga tercapai apa yang ipang inginkan."],
  startDelay: 4000,
  speed: 75,
...
new TypeIt("#teks2", {
  strings: ["Dengan ataupun tanpaku, semoga semesta selalu membahagiakan ipang bagimanapun caranya.", " ", "barakallah fi umrik, terima kasih sudah bertahan sampai sejauh ini.", " ", "- Wish all you the best"],
  startDelay: 2000,
  speed: 75,
  waitUntilVisible: true
}).go();
